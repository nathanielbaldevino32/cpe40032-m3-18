...
function love.load()
    ...
    gFrames = {
        ...
        --powerup 2
        --THE FUNCTION WE ADDED FROM THE UTIL.LUA MUST BE CALLED IN MAIN.LUA
    ...
    gSounds = {
        ...
        ['victory'] = love.audio.newSource('sounds/altvictory.wav'),
        ['recover'] = love.audio.newSource('sounds/recover.wav'),
        ['high-score'] = love.audio.newSource('sounds/high_score.wav'),
        ['pause'] = love.audio.newSource('sounds/pause.wav'),
        ['play'] = love.audio.newSource('sounds/altplay.wav'),
        ['checkscores'] = love.audio.newSource('sounds/checkscores.wav'),
        ['menu'] = love.audio.newSource('sounds/altmenu.wav')
    }
