...
--powerup 1
--THIS FUNCTION EXTRACTS OUR POWERUP SPRITE FROM THE TEXTURE
function GenerateQuadsPowerups(atlas)
    ...
    local quads = {}
    for i = 0, 10 do
        quads[counter] = love.graphics.newQuad(x+96, y, 16, 16, atlas:getDimensions())
        x = x + 48
        counter = counter + 1
    end
...
--lockedbricked 1
-- WHILE THIS FUNCTION EXTRACTS OUR LOCKEDBRICK SPRITE FROM THE TEXTURE
